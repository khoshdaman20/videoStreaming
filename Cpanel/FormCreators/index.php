                                ...
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            $sql = "SELECT * FROM formbuilders f join translate t on f.ID = t.Form_ID where TableName = '" . $_GET["pages"] . "'";
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td><a href='back\\" . $_GET["pages"] . ".php?Action=Delete&ID=" . $row["ID"] . "'>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="back\<?php echo  $_GET["pages"] ?>.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                if ($row["EN"] == "Images") {
                                    echo "<div class='custom-file-container' data-upload-id='myFirstImage'>
                                    <label>انتخاب عکس  <a href='javascript:void(0)' class='custom-file-container__image-clear' title='Clear Image'>   </a></label>
